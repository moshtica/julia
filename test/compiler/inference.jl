...
f_apply_llvmcall(args...) = Core.Intrinsics.llvmcall(args...)
@test Core.Compiler.return_type(f_apply_llvmcall, Tuple{Vararg}) == Any
@test Core.Compiler.return_type(f_apply_llvmcall, Tuple{Any,Vararg{Type{Int}}}) == Int
@test Core.Compiler.return_type(f_apply_llvmcall, Tuple{Any,Type{Int},Vararg}) == Int
@test Core.Compiler.return_type(f_apply_llvmcall, Tuple{Any,Type{Int},Any,Vararg}) == Int
@test Core.Compiler.return_type(f_apply_llvmcall, Tuple{Any,Type{Int},Any,Any,Vararg}) == Int
@test Core.Compiler.return_type(f_apply_llvmcall, Tuple{Any,Type{Int},Any,Any,Any,Vararg}) == Int
